        ...
        namespace someip
        {
            namespace sd
            {
                                              ...
                                              mEndpointLock(mEndpointMutex, std::defer_lock)
                {
                    ...
                    // prepare message that will be send 
                    ...
                    // store InvokeHandler in hash table that poller uses
                    auto _receiver =
                        std::bind(
                            &SomeIpSdClient::InvokeHandler,
                            this,
                            std::placeholders::_1);
                ...
                void SomeIpSdClient::InvokeHandler(SomeIpSdMessage &&message)
                {
