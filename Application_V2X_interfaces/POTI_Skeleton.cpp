...
static const uint16_t c_Udp_port = 1000;
...
namespace ara 
{
    namespace com
    {
        namespace skelton
        {
            POTI_Skeleton::POTI_Skeleton( ara::com::InstanceIdentifier id) : EventServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
