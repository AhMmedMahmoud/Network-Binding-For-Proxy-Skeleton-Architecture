...
static const uint16_t c_ServiceId = 14;
...
namespace ara 
{
    namespace com
    {
        ...
        {    
                ...
                std::future<bool> CAM_VDP_Proxy::setter(std::vector<uint8_t> data)
                {
                ...
                void CAM_VDP_Proxy::requestGetting()
                {
                ...
                /*
                bool CAM_VDP_Proxy::isSubscribed(int duration)
                {
