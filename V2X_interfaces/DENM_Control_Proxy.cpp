...
static const uint16_t c_ServiceId = 16;
...
namespace ara 
{
    namespace com
    {
        ...
        {    
                ...
                std::future<bool> DENM_Control_Proxy::setter(std::vector<uint8_t> data)
                {
                ...
                void DENM_Control_Proxy::requestGetting()
                {
                ...
                /*
                bool DENM_Control_Proxy::isSubscribed(int duration)
                {
